...
// const spaceCrafName: string = 'Determination';
...
// console.log(`${spaceCrafName} will take ${daysToMars} to get to Mars`);
...
//     const daysAway: number = hoursToLocation / 24;
//     return daysAway;
// }
// // Move your output statement from part 2 here. Update the template literal to call
// // the function and print the outputs for a Mars trip and a moon trip.
// console.log(`${spaceCrafName} will take ${getDaysToLocation(kilometersToMars)} to get to Mars`);
// console.log(`${spaceCrafName} will take ${getDaysToLocation(kilometersToTheMoon)} to get to the Moon`);
